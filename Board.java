...
public class Board extends Parent {
     ...
     *
     * A specialized Board constructor that when a coordinate is found in the
     * coordinate array, when the Cell is created, it colors it a Green.
     */
    Board(int[] carrierArray, int[] battleshipArray, int[] cruiserArray,
        ...
        //when the coordinate is found within the coordinate arrays, it becomes false. -EM
